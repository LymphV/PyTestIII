...
def merge_patent(eid,aff_id):
    ...
    for i,patent in patent_list.iterrows():        
        ...
        if patent['inventor'] is not None or not patent['inventor'] == "":
        ...
        if patent['applicationNameList'] is not None or not patent['applicationNameList'] == "":
            app_name_list = list(set(ast.literal_eval(patent['applicationNameList'])))
