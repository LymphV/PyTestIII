...
#             print(i+1, end=' ',file=open(errorLogName, 'a+',encoding='UTF-8'))
        print(num,file=open(errorLogName, 'a+',encoding='UTF-8'))
    except UserMysqlException as e:
        print("出错专利序号：",num, end=' ',file=open(errorLogName, 'a+',encoding='UTF-8'))
...
def main():
    ...
    while _retries_count <= _max_retries_count:
        try:
            num = start_execute()
            if num == 1:
                break
